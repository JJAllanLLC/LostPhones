(function (global, factory) {
  ...
  const actions = Object.freeze([
    ...
    record({
      ...
      leavingLabel: 'Apple Find Devices will open in a new tab. Keep this page open and come back when you finish.',
    ...
    record({
      ...
      leavingLabel: 'Google Find Hub will open in a new tab. Keep this page open and come back when you finish.',
    ...
    record({
      ...
      title: 'First, check your iPhone’s location.',
      reason: 'This tells us whether to focus on finding the phone or protecting your accounts.',
      ...
      primaryControlLabel: 'Open Apple Find Devices',
      leavingLabel: 'Apple Find Devices will open in a new tab. Keep this page open and come back when you finish.',
      returnPrompt: 'Back from Apple? Tell us what you found. LostPhones does not infer a location from the tab opening.',
      requiresExternalReturn: true,
      planLane: 'now',
    ...
    record({
      ...
      title: 'First, check your Android’s location.',
      reason: 'This tells us whether to focus on finding the phone or protecting your accounts.',
      ...
      primaryControlLabel: 'Open Google Find Hub',
      leavingLabel: 'Google Find Hub will open in a new tab. Keep this page open and come back when you finish.',
      returnPrompt: 'Back from Google? Tell us what you found. LostPhones does not infer a location from the tab opening.',
      requiresExternalReturn: true,
      planLane: 'now',
      boundedOutcomes: LOCATE_OUTCOMES
    }),
    ...
    record({
      ...
      leavingLabel: 'Apple Account Recovery will open in a new tab. Keep this page open and come back when you finish.',
    ...
    record({
      ...
      leavingLabel: 'Google Account Recovery will open in a new tab. Keep this page open and come back when you finish.',
    ...
    record({
      ...
      leavingLabel: 'Apple Account will open in a new tab. Keep this page open and come back when you finish.',
    ...
    record({
      ...
      leavingLabel: 'Google Account security will open in a new tab. Keep this page open and come back when you finish.',
